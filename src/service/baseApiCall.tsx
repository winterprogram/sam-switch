import { GET_SAM_SWITCH, REDEEMED } from "./apiEndPoints";
...
export const apiCall = (
  ...
  if (endpoint.includes("redeemed?") || endpoint.includes("switch?")) {
    let country = "";
    if (Intl) {
    ...
    DyanamicConfig = { ...DyanamicConfig, headers: { "X-COUNTRY": country } };
  }

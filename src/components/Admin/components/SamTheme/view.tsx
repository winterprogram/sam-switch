    ...
    <div className="flex w-full">
      ...
      >
        <div className="flex flex-row justify-between">
          <span className="text-3xl min-w-fit font-bold p-4">Sam Theme</span>
          <span className="ml-8">
            <button
              onClick={() => {
                setDeleteModal(true);
            ...
            <button
              onClick={() => navigate(`/dashboard/samtheme/edit/${id}`)}

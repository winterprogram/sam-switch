  ...
  return (
    <div className="bg-black w-screen">
      ...
      <div>
        ...
        {loading ? (
          <div className="h-[calc(100vh-192px)] md:h-[calc(100vh-200px)] mt-14 animate-pulse flex flex-row justify-center py-4">
            <svg
              aria-hidden="true"
              className="mr-2 h-14 w-14 text-gray-200 animate-spin dark:text-gray-600 fill-cyan-500"
              viewBox="0 0 100 101"
              fill="none"
          ...
          <div className="h-[calc(100vh-136px)] md:h-[calc(100vh-144px)] overflow-y-auto">
            <div className="mx-6 sm:mx-12 lg:mx-20 2xl:mx-auto mt-5 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-4 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 2xl:gap-8 mb-10 w-fit">
